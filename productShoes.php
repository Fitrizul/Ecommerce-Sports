  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center mb-5">
        <h1 class="font-weight-bold">All latest Shoes</h1>
      </div>
      
      <?php

        include "config.php";
        // Fetching shoes product from database
      ...
      ?>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 mb-4">
            ...
            <div class="product-info">
              <?php
                  if($row['name'] == "Nike Shoes White")
                  {
                  ?>
                    <h4 class="mb-2" style="margin-top:34px;"><a href="product-details2.php?productId=<?php echo $row['product_id'];?>" class="link-title"><?php echo $row['name']; ?></a></h4>
                  <?php
                  }
                  elseif($row['name'] == "Puma Shoes Blue")
                  {
                  ?>
                    <h4 class="mb-2" style="margin-top:44px;"><a href="product-details2.php?productId=<?php echo $row['product_id'];?>" class="link-title"><?php echo $row['name']; ?></a></h4>
                  <?php
                  } 
                  else
                  {

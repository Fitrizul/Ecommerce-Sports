  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center mb-5">
        <h1 class="font-weight-bold">All latest Jerseys</h1>
      </div>
      
      <?php

        include "config.php";
        // Fetching jerseys product from database
        $sql = "Select * from products where category = 'Jerseys'";
